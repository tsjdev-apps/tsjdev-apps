...
I'm **Thomas Sebastian Jensen** – most people just call me **Sebastian**.

I’m a **Senior Software Engineer & Team Lead** focusing on modern **.NET development**, building apps, tools, samples and libraries for developers around the world.  

I love creating **open-source packages**, writing **technical articles**, and exploring the latest in **AI, .NET, and cross-platform development**.

## 🚀 What I Work On

- 💻 Focusing on **C#**, **ASP.NET Core**, **Blazor**, and **.NET MAUI**
- 🎨 Learning **Swift** & **SwiftUI**
- 📦 Publishing **NuGet packages** and maintaining OSS libraries  
- ✍️ Writing blog posts in  
  - 🇩🇪 German: [tsjdev-apps.de](https://www.tsjdev-apps.de)
  - 🇬🇧 English: [medium.com/@tsjdevapps](https://medium.com/@tsjdevapps)

## 📬 Connect with Me

- 🐦 X/Twitter: [@tsjdevapps](https://twitter.com/tsjdevapps)
- 💼 LinkedIn: [in/thomassebastianjensen](https://linkedin.com/in/thomassebastianjensen)
- ▶️ YouTube: [youtube.com/@tsjdevapps](https://youtube.com/tsjdevapps)
- 📧 Email: [apps@tsjdev-apps.de](mailto:apps@tsjdev-apps.de  )

## 📝 Latest Medium Posts (English)

<!-- MEDIUM-BLOG-POST-LIST:START -->
- [Building a Seven-Segment Display Control with .NET MAUI and SkiaSharp](https://medium.com/@tsjdevapps/building-a-seven-segment-display-control-with-net-maui-and-skiasharp-739adf1ca8d9?source=rss-c8f6762e0e4b------2)
- [From Commit to MSIX: Automating .NET MAUI Windows Builds with GitHub Actions](https://medium.com/medialesson/from-commit-to-msix-automating-net-maui-windows-builds-with-github-actions-9e1709a7e5dd?source=rss-c8f6762e0e4b------2)
- [From Commit to IPA: Automating .NET MAUI iOS Builds with GitHub Actions](https://medium.com/medialesson/from-commit-to-ipa-automating-net-maui-ios-builds-with-github-actions-fd8d9d47240b?source=rss-c8f6762e0e4b------2)
...
- [Vor der IPA: iOS Signing für .NET MAUI vorbereiten](https://www.tsjdev-apps.de/vor-der-ipa-ios-signing/)
- [Von Commit zu AAB/APK: .NET MAUI Android Builds mit GitHub Actions automatisieren](https://www.tsjdev-apps.de/von-commit-zu-aab-apk/)
- [Erstellen eines Seven Segment Display Controls mit .NET MAUI und SkiaSharp](https://www.tsjdev-apps.de/erstellen-eines-seven-segment-display-controls-mit-dotnet-maui-und-skiasharp/)
- [Image Sortr: Bilder automatisch nach Aufnahmedatum sortieren](https://www.tsjdev-apps.de/image-sortr-bilder-nach-aufnahmedatum-sortieren/)
- [Tiny Tool Town: Kleine Tools, große Freude](https://www.tsjdev-apps.de/tiny-tool-town-kleine-tools-grosse-freude/)
...
![NuGet](https://img.shields.io/badge/NUGET-%23000000.svg?style=for-the-badge&logo=nuget&logoColor=white&color=004880)
![OpenAI](https://img.shields.io/badge/OpenAI-412991.svg?style=for-the-badge&logo=openai&logoColor=white&color=004880)
...
If you like what I do, feel free to support me — by using my projects, sharing my work, or buying me a coffee.
...
![Top Languages](https://denvercoder1-github-readme-stats.vercel.app/api/top-langs/?username=tsjdev-apps&langs_count=6&theme=react&bg_color=1F222E&title_color=F85D7F&icon_color=F8D866)
...
<img alt="tsjdev-apps's Activity Graph" src="https://github-readme-activity-graph.vercel.app/graph/?username=tsjdev-apps&bg_color=1F222E&color=F8D866&line=F85D7F&point=FFFFFF" />
